    ...
    public static final RegistryObject<CreativeModeTab> POTATO_TAB = CREATIVE_MODE_TABS.register("potato_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack((PotatoItems.POISONOUS_POTATO.get())))
                    ...
                    .displayItems((pParameters,pOutput) -> {
                        ...
                        pOutput.accept(PotatoBlocks.POISONOUS_POTATO_ZOMBIE_HEAD_BLOCK.get());
                        pOutput.accept(PotatoBlocks.POISONOUS_POTATO_ZOMBIE_HEAD_HAT.get());
                        pOutput.accept(PotatoBlocks.POISON_FARMLAND.get());
                        pOutput.accept(PotatoBlocks.POISON_PATH.get());
                        pOutput.accept(PotatoBlocks.POTATOES.get());
                        pOutput.accept(PotatoBlocks.POTATO_BATTERY.get());
//                        pOutput.accept(PotatoBlocks.POTATO_BUD.get());
                        pOutput.accept(PotatoBlocks.POISONOUS_POTATO_CUTTER.get());
//                        pOutput.accept(PotatoBlocks.POTATO_DOOR.get());
                        pOutput.accept(PotatoBlocks.POTATO_FLOWER.get());
                        pOutput.accept(PotatoBlocks.POTATO_FRUIT.get());
...
//                        pOutput.accept(PotatoBlocks.POTATO_PEDICULE.get());
                        ...
                        pOutput.accept(PotatoBlocks.POTATO_REFINERY.get());
